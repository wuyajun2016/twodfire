 ...
 *
 * 食记火会员/food/dairy/v1/my_fire_member_info
 */
public class MyFireMemberInfoTest extends TestBase{
	...
	public void test(Map<String, String> data) throws Exception{
        ...
        try {
        	...
        	patUrl.add(http_url);
        	patUrl.add("/food/dairy/v1/my_fire_member_info");
        ...
        Assert.assertEquals(resp.get("data").getAsJsonObject().get("fireGrade"), resp2.get("data").getAsJsonObject().get("fireSeedLevel"), " 食记火会员fireGrade不一致");
