...
/**
 * @author sangye  2017年2017年8月30日
 *
 * 活动列表 /bz/district/v1/activities
 * http://10.1.24.109:8080/consumer-api/bz/district/v1/activities?uid=13675832423&index=1&format=json&appKey=100011&timestamp=1504488457755&token=XIANMAOTEST
 */
public class ActivitiesListTest extends TestBase{
	...
	public void test(Map<String, String> data) throws Exception{
        ...
        try {
        	...
        	patUrl.add(http_url);
        	patUrl.add("/bz/district/v1/activities");
